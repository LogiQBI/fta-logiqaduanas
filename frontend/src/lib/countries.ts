// Catálogo de países ISO 3166-1 alfa-2 (código + nombre en español).
export const COUNTRIES: { code: string; name: string }[] = [
  ...
  { code: "BS", name: "Bahamas" }, { code: "BH", name: "Baréin" },
  { code: "BD", name: "Bangladés" }, { code: "BB", name: "Barbados" },
  { code: "BE", name: "Bélgica" }, { code: "BZ", name: "Belice" },
  { code: "BJ", name: "Benín" }, { code: "BM", name: "Bermudas" },
  { code: "BT", name: "Bután" }, { code: "BY", name: "Bielorrusia" },
  ...
  { code: "CD", name: "Congo (R.D.)" }, { code: "KP", name: "Corea del Norte" },
  { code: "KR", name: "Corea del Sur" }, { code: "CI", name: "Costa de Marfil" },
  { code: "CR", name: "Costa Rica" }, { code: "HR", name: "Croacia" },
  { code: "CU", name: "Cuba" }, { code: "CW", name: "Curazao" },
  { code: "DK", name: "Dinamarca" }, { code: "DM", name: "Dominica" },
  ...
  { code: "ET", name: "Etiopía" }, { code: "PH", name: "Filipinas" },
  { code: "FI", name: "Finlandia" }, { code: "FJ", name: "Fiyi" },
  ...
  { code: "GL", name: "Groenlandia" }, { code: "GP", name: "Guadalupe" },
  { code: "GU", name: "Guam" }, { code: "GT", name: "Guatemala" },
  { code: "GF", name: "Guayana Francesa" }, { code: "GG", name: "Guernsey" },
  ...
  { code: "HK", name: "Hong Kong" }, { code: "HU", name: "Hungría" },
  { code: "IN", name: "India" }, { code: "ID", name: "Indonesia" },
  { code: "IQ", name: "Irak" }, { code: "IR", name: "Irán" },
  { code: "IE", name: "Irlanda" }, { code: "IS", name: "Islandia" },
  { code: "KY", name: "Islas Caimán" }, { code: "CK", name: "Islas Cook" },
  { code: "FO", name: "Islas Feroe" }, { code: "FK", name: "Islas Malvinas" },
  { code: "MP", name: "Islas Marianas del Norte" }, { code: "MH", name: "Islas Marshall" },
  { code: "SB", name: "Islas Salomón" }, { code: "VG", name: "Islas Vírgenes (R.U.)" },
  { code: "VI", name: "Islas Vírgenes (EE.UU.)" }, { code: "IL", name: "Israel" },
  ...
  { code: "PW", name: "Palaos" }, { code: "PS", name: "Palestina" },
  ...
  { code: "GB", name: "Reino Unido" }, { code: "CF", name: "Rep. Centroafricana" },
  { code: "CZ", name: "Rep. Checa" }, { code: "DO", name: "Rep. Dominicana" },
  { code: "RE", name: "Reunión" }, { code: "RW", name: "Ruanda" },
  { code: "RO", name: "Rumania" }, { code: "RU", name: "Rusia" },
  { code: "WS", name: "Samoa" }, { code: "AS", name: "Samoa Americana" },
  { code: "KN", name: "San Cristóbal y Nieves" }, { code: "SM", name: "San Marino" },
  { code: "VC", name: "San Vicente y las Granadinas" }, { code: "SH", name: "Santa Elena" },
  ...
  { code: "LK", name: "Sri Lanka" }, { code: "ZA", name: "Sudáfrica" },
  { code: "SD", name: "Sudán" }, { code: "SS", name: "Sudán del Sur" },
  { code: "SE", name: "Suecia" }, { code: "CH", name: "Suiza" },
  { code: "SR", name: "Surinam" }, { code: "TH", name: "Tailandia" },
